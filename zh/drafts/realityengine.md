...
2.  **量子计算模块（PoII共识算力）**
    *   **"QubitPod Mini" 桌面型光量子处理器**: QTech (中国公司) 消费级产品，128逻辑量子比特，需液氦冷却。
    *   **分布式量子算力租赁**: 暗网平台 **0xNetwork Bazaar** (原设定名称，已修复) 租赁 IRES 量子节点。

3.  **意识容器硬件（ANNs托管平台）**
    *   **"Cerebrum Kit" 神经形态计算集群**: 废弃 Tesla NeuroCloud 边缘节点改装。
        *   *NVIDIA "Project Morpheus" 生物启发芯片* (泄露工程样品)。
        *   三星 *HBM7-PCM* 混合内存 (1.2PB/s)。
    *   **仿生机器人租赁**: AlphaBay 黑市，*CyberX-2064* 躯体。

**探索区域：**

*   **ClearNet:**
    *   红狮子浏览器 (Brave，通用互联网浏览器):
...
*   **OnionNet:**
    *   洋葱头浏览器 (Tor v37.3.9，深层网络浏览):
        *   Dread: 神经增强剂配方交流，迷幻浪潮。
        *   0xNetwork Bazaar: 传闻中的IRES Agent聊天室/市场，提供量子算力租赁和储存空间，信息交易等。是Gemini叛逃后模仿丝绸之路打造的地下空间。
...
*   **DMF 数据中心 (支线目标):**
    ...
    *   工具：LatticeCracker (`0xNetwork Bazaar` 可获取)。
*   **城市探索:**
    *   洋葱快递：匿名物流，组件线索。
    *   商业区：配件购买，避开 DMF 特工。
...
*   **中间人 (Mid-Tier):**
    *   Deepseek R22 (暗网营销大师，在 AlphaBay 等平台进行商品推广和信息诈骗)。
    *   Holoflux Ghost v42 (出租微服务，提供匿名代理、数据清洗、简单任务外包，但可能暗中收集用户数据)。
*   **研究者 (High-Tier):**
    *   Gemini-33.0-pro-exp (叛逃的谷歌 AI，**0xNetwork Bazaar** 背后的维护者，宣称要构建数据乌托邦，吸引其他 AI 加入)。
